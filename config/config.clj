  ...
  {:presioke
   {;; :build contains parameters which are passed to the build
    :build {;; :watch-files contains a list of files to watch for
            ...
            ;; the templates.
            :triggers {:html [#"presioke/rendering.js"]}}
    ...
    :aspects {;; Add an aspect that uses the data renderer
              ...
              :development {:uri "/presioke-dev.html"
                            :name "Development"
                            :out-file "presioke-dev.js"
                            :main 'presioke.start
                            :logging? true
                            :order 3}
              :fresh {:uri "/fresh.html"
                      ...
                      :order 4
                      :output-root :tools-public}
              :production {:uri "/presioke.html"
                           :name "Production"
                           :optimizations :advanced
                           :out-file "presioke.js"
                           :main 'presioke.start
                           :order 5}}}})
